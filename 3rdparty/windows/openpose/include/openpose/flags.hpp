...
DEFINE_string(camera_resolution,        "320x240",        "Set the camera resolution (either `--camera` or `--flir_camera`). `-1x-1` will use the"
...
DEFINE_string(ip_camera,                "http://192.168.178.21:8081/",             "String with the IP camera URL. It supports protocols like RTSP and HTTP.");
...
DEFINE_string(net_resolution,           "-1x336",       "Multiples of 16. If it is increased, the accuracy potentially increases. If it is"
...
DEFINE_string(face_net_resolution,      "336x336",      "Multiples of 16 and squared. Analogous to `net_resolution` but applied to the face keypoint"
...
DEFINE_string(hand_net_resolution,      "336x336",      "Multiples of 16 and squared. Analogous to `net_resolution` but applied to the hand keypoint"
                                                        " detector.");
